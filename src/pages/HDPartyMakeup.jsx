...
import secondImage from '../assets/hdparty/WhatsApp Image 2026-04-08 at 2.46.10 PM.jpeg';

const HDPartyMakeup = () => {
    const partyImages = [
        { url: mainImage, title: "Glow Party Look" },
        { url: secondImage, title: "Sharp Definition" },
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-16 md:gap-24">
                        ...
                        <div className="flex-1 relative">
                            ...
                            >
                                <img src={mainImage} alt="HD Philosophy" className="w-full h-full object-cover" />
                            </motion.div>
