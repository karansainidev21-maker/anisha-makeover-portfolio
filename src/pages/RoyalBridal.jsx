...
import mainImg from '../assets/royalbridalimg/royal_bridal_main.png';
import secondImg from '../assets/royalbridalimg/royalbridalsecond.jpeg';
import thirdImg from '../assets/royalbridalimg/royalbridal3.jpeg';
import fourthImg from '../assets/royalbridalimg/royalbridal4.jpeg';
import fifthImg from '../assets/royalbridalimg/royalbridal5.jpeg';
import sixthImg from '../assets/royalbridalimg/royalbridal6.jpeg';

const RoyalBridal = () => {
    const bridalImages = [
        { url: mainImg, title: "The Signature Royal" },
        { url: secondImg, title: "Heritage Elegance" },
        { url: thirdImg, title: "Golden Radiance" },
        { url: fourthImg, title: "Jeweled Masterpiece" },
        { url: fifthImg, title: "Timeless Tradition" },
        { url: sixthImg, title: "Classic Bridal Glow" }
    ];
    ...
    return (
        <div className="bg-[#0A0A0A] min-h-screen text-white selection:bg-secondary selection:text-white overflow-x-hidden">
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-9xl font-serif font-black text-white leading-[0.9] mb-10">
                            Royal <br /> <span className="text-secondary italic">Bridal Grace</span>
                        </h1>
                        ...
                        <p className="text-white/50 font-sans max-w-2xl mx-auto leading-relaxed text-base md:text-xl italic px-4 font-light">
                            "Where heritage meets modern majesty. A transformation designed for the queen within, blending timeless tradition with high-fashion elegance."
                        </p>
                    </motion.div>
                </div>
                    ...
                    {bridalImages.map((image, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-black via-black/40 to-transparent lg:translate-y-6 lg:opacity-0 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-500">
                                <span className="text-secondary text-[10px] font-bold tracking-widest uppercase mb-2 block">COLLECTION {index + 1}</span>
            ...
            {/* Feature Section - The Bridal Philosophy */}
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-16 md:gap-24">
                        <div className="flex-1">
                            ...
                            >
                                <h2 className="text-4xl md:text-7xl font-serif font-black mb-8 leading-tight">
                                    The Essence of <br /> Royal Grandeur
                                </h2>
                                <p className="text-secondary text-xl mb-10 leading-relaxed uppercase tracking-widest font-bold">
                                    Heritage. Majesty. Timelessness.
                                </p>
                                <p className="text-white/50 text-xl mb-12 leading-relaxed font-light">
                                    Every bride is a queen on her special day. Our Royal Bridal technique focuses on highlighting traditional features while ensuring a modern, lightweight feel. We use premium, heirloom-quality pigments that complement heavy jewelry and intricate bridal attire.
                                </p>
                                <ul className="space-y-6">
                                    {['Jeweled Precision', 'Heritage-Focused Glow', 'Photography Optimization', 'Long-wear Durability'].map((item, i) => (
                        ...
                        <div className="flex-1 relative">
                            ...
                            >
                                <img src={mainImg} alt="Bridal Philosophy" className="w-full h-full object-cover" />
                            </motion.div>
                ...
                <div className="container mx-auto px-6 text-center z-10 relative">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                            <Link
                                to="/#contact"
                                className="group relative inline-flex items-center justify-center overflow-hidden px-12 py-5 bg-secondary text-dark rounded-full text-[10px] md:text-xs font-black tracking-widest transition-all duration-300"
                            >
                                <span className="relative z-10 uppercase">BOOK YOUR HERITAGE LOOK</span>
                            </Link>
                            <Link
                                to="/#portfolio"
